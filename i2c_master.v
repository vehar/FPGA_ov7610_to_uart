...
`timescale 1ns / 1ps
//////////////////////////////////////////////////////////////////////////////////
// Company:  https://www.circuitden.com/blog/21
...
module i2c_master #(
	...
	input   wire							external_serial_data_i,
	//input   wire							external_serial_clock_i, 
    output  wire                            external_serial_data,
    output  wire                            external_serial_clock,
    output  wire                            external_serial_data_oe,
    output  wire                            external_serial_clock_oe,
 //   output  wire                            dbg
);

//assign dbg = external_serial_data_oe;
...
assign external_serial_clock    =   serial_clock;
assign external_serial_data     =   serial_data;

assign external_serial_clock_oe    =   ~serial_clock_output_enable;
assign external_serial_data_oe     =   ~serial_data_output_enable;
        ...
        S_WRITE_REG_ADDR: begin
            if (divider_tick) begin
                case (process_counter)
                    ...
                    3: begin
                        if (bit_counter == 0) begin
                            if (read_write == 0) begin //On Write
            ...
            if (divider_tick) begin
                case (process_counter)
                    ...
                    2: begin
                        ...
                        _miso_data[bit_counter+7]   =   external_serial_data_i;
                        _bit_counter                =   bit_counter - 1;
                        _process_counter            =   3;
                    end
                    3: begin
            ...
            if (divider_tick) begin
                case (process_counter)
                    ...
                    2: begin
                        _serial_clock       =   0;
                        //sample data on this rising edge of scl
                        _miso_data[bit_counter-1]   =   external_serial_data_i;
                        _bit_counter                =   bit_counter - 1;
                        _process_counter    =   3;
                    end
                    3: begin
